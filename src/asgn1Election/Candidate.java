...
public class Candidate {
	 ...
	 * Throws an exception if there is an incorrect value in the candidate passed.
	 */
	public Candidate(String candName, String candParty, String candAbbrev, int voteCount) throws ElectionException {
		if (voteCount < 0 || candName == null || candName.trim() == "" || candParty == null || candParty.trim() == "" || candAbbrev == null|| candAbbrev.trim() == "") {
		 throw new ElectionException("Invalid inputs to constructor");
		}
		this.name = candName;
	 ...
	 */
	// Creates a deep copy of the candidate.
